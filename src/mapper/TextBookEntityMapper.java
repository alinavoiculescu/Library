...
public class TextBookEntityMapper implements RowMapper<TextBookEntity> {
    ...
    public TextBookEntity mapRow(ResultSet resultSet) throws SQLException {
        ...
        return new TextBookEntity(isbn, title, authorEntity, numberOfPages, price, sectionEntity, subject);
    }
}
